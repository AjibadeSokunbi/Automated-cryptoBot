...
const Remove: FC<Props> = ({ poolData, data }) => {
  return (
    <Stack flexDirection="col" sx="w-full" height="h-[290px]" padding="mt-2">
      <Table className="hide-scrollbar overflow-y-auto">
        <TableHeader className="border-none w-full">
          <TableRow className="border-none text-[#6C757D]  flex justify-between px-2  py-1.5">
            <TableHead2 className="w-[20px] md:w-1/2 lg:w-1/2 text-xs font-bold leading-none">
              
            </TableHead2>
            <TableHead2 className="w-[80px] md:w-full lg:w-full text-xs font-bold leading-none">
              Time
            </TableHead2>
            <TableHead2 className="w-[100px] md:w-full lg:w-full text-xs font-bold leading-none">
              Token Amount
            </TableHead2>
            <TableHead2 className="w-[80px] md:w-full lg:w-full text-xs font-bold leading-none">
              Token Value
