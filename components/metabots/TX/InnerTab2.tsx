  ...
  return (
    ...
    <Stack justifyContent="between" sx="w-full flex-col md:flex-row  lg:flex-row ">
      <TabsList className="w-[85%] md:w-fit lg:w-fit flex justify-between h-[25px] md:h-[29px] lg:-[29px] gap-3 md:gap-3 lg:gap-3 mb-0 md:mb-0 lg:mb-0">
        ...
        >
          <span className="hidden md:inline lg:inline text-[10px] md:text-sm lg:text-base"> Transactions </span>
        ...
        >
          ...
          <span className="text-[10px] md:text-sm lg:text-base"> New Tokens </span> 
        </TabsTrigger>
        <TabsTrigger
          value="watchlist"
          className="relative font-bold font-['Instrument Sans'] leading-tight cursor-pointer data-[state=active]:border-b-2 data-[state=active]:border-y-blue-500  data-[state=active]:text-[#6C757D]"
        >
                     <WatchCount />
          <span className="text-[10px] md:text-sm lg:text-base"> Watchlist </span> 
        </TabsTrigger>
      </TabsList>


      <TabsList className="flex justify-end md:justify-between lg:justify-between w-full md:w-auto lg:w-auto mt-2 mb-0 md:mb-0 lg:mb-0">
          <TabsTrigger
            value="New Tokens"
