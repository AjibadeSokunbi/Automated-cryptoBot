...
{/* <TableHead2 className="w-7/12 text-xs font-bold leading-none">
Age
</TableHead2>
<TableHead2 className="w-full flex justify-center text-center  text-xs font-bold leading-none">
Token Name
</TableHead2> */}
const NewTokens: FC<Props> = ({ NewData, ape }) => {
  return (
      ...
      <Table className="hide-scrollbar overflow-y-auto hidden md:table lg:table w-full">
        <TableHeader className="border-none w-full bg-slate-950">
          <TableRow className="border-none flex justify-between px-2  py-1.5">
            <TableHead2 className={!ape ? "w-7/12 text-xs font-bold leading-none" : "w-full text-xs font-bold leading-none"}>
              Age
            </TableHead2>
            <TableHead2 className={!ape ? "w-full flex justify-center text-center  text-xs font-bold leading-none" : "w-full text-xs font-bold leading-none"}>
              Token Name
            </TableHead2>
            {ape && (
