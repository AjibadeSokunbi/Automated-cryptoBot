import IUniswapV3PoolABI from "./IUniswapV3PoolABI.json";
    ...
    try {
      ...
      if (factory === "0x1F98431c8aD98523631AE4a59f267346ea31F984") {
        ...
        const token1Amount = parseFloat(
          ethers.utils.formatUnits(reserveToken0, token0Decimals)
        );
        const token2Amount = parseFloat(
          ethers.utils.formatUnits(reserveToken2, token1Decimals)
        );
